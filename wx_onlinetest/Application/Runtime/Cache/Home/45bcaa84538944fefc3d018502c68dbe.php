...
<div class="page_hd">
    ...
    <div class="weui-grids">
        <a href="<?php echo U('Common/skillTest');?>" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="/wx_onlinetest/Public/Static/images/icon_tabbar.png" alt="">
            </div>
            <p class="weui-grid__label">技能考评</p>
        </a>  
        <a href="<?php echo U('Common/pysTest');?>" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="/wx_onlinetest/Public/Static/images/icon_tabbar.png" alt="">
            </div>
            <p class="weui-grid__label">素质考评</p>
        </a>  
        <a href="<?php echo U('Common/myScore');?>" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="/wx_onlinetest/Public/Static/images/icon_tabbar.png" alt="">
            </div>
