...
<body ontouchstart>
<form action="<?php echo U('Common/index');?>" method="post">
        <?php if(is_array($kind)): foreach($kind as $key=>$vo): ?><div class="weui-cells__title">用户名</div>
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="username" placeholder="请输入用户名" value="<?php echo ($vo["user_name"]); ?>">
                </div>
            </div>
        </div>

        <button type="submit" class="weui-btn weui-btn_plain-primary">提交修改</button><?php endforeach; endif; ?>   
</form>
<div class="footer">
<div class="weui-tab">
