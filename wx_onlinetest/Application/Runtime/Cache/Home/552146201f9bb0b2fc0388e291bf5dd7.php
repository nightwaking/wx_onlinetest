...
<head>
    ...
    <div class="page_hd">
        <div class="weui-cells__title">员工分数查看</div>
    </div>
    <?php if(is_array($skill)): foreach($skill as $key=>$vo): ?><div class="weui-form-preview">
            ...
            <div class="weui-form-preview__bd">
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">技能测试名</label>
                    <span class="weui-form-preview__value"><?php echo ($vo["skill_name"]); ?></span>
                </div>
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">技能测试分数</label>
                    <span class="weui-form-preview__value"><?php echo ($vo["skill_mark"]); ?></span>
                </div>
            </div>
        </div><?php endforeach; endif; ?>
    <?php if(is_array($psy)): foreach($psy as $key=>$vo): ?><div class="weui-form-preview">
            <div class="weui-form-preview__hd">
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">用户名</label>
                    <em class="weui-form-preview__value"><?php echo ($vo["user_name"]); ?></em>
            ...
            <div class="weui-form-preview__bd">
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">素质测试名</label>
                    <span class="weui-form-preview__value"><?php echo ($vo["p_name"]); ?></span>
                </div>
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">素质测试分数</label>
                    <span class="weui-form-preview__value"><?php echo ($vo["psy_mark"]); ?></span>
                </div>
            </div>
        </div><?php endforeach; endif; ?>
<div class="footer">
