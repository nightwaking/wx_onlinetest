...
<body ontouchstart>
<form action="<?php echo U('Admin/add_skill');?>" method="post">
        <div class="weui-cells__title">测评添加</div>
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="skill_name" placeholder="输人测评名称">
                </div>
            </div>
        </div>
