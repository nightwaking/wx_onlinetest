...
<body ontouchstart>
    <div class="page__bd">
        ...
        <?php if(is_array($kind)): $i = 0; $__LIST__ = $kind;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="weui-cells">
            <div class="weui-cell weui-cell_access">
                ...
                <div>
                    <a class="weui-btn weui-btn_mini weui-btn_default" href= "<?php echo U('Pyschology/add_choice', array('id'=>$vo['qid'], 'sid'=>$vo['add_id']));?>">添加选项</a>
                    <a class="weui-btn weui-btn_mini weui-btn_warn" href= "<?php echo U('Pyschology/question_delete', array('id'=>$vo['qid']));?>">删除题目</a>
                </div>
            </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>

    <form action="<?php echo U('Pyschology/add_question');?>" method="get">
    <div class="weui-cell weui-cell_select weui-cell_select-before">
                ...
                <input type="text" name="q_type" value="0" hidden="hidden">
