...
<div class="page">
    <div class="page__hd">
        <h1 class="page__title">员工测评系统</h1>
<!--        <p class="page__desc">信息管理</p>-->
    </div>
    
        
        <a href="change_password.php" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="./wx_onlinetest/Public/Static/images/icon_tabbar.png" alt="">
            </div>
            <p class="weui-grid__label">修改密码</p>
        </a>
        <a href="votes.php" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="./images/icon_tabbar.png" alt="">
            </div>
            <p class="weui-grid__label">投票</p>
        </a>  
        <a href="feedback_add.php" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="./images/icon_tabbar.png" alt="">
            </div>
            <p class="weui-grid__label">问题反馈</p>
        </a>  
        <a href="myscore.php" class="weui-grid">
            <div class="weui-grid__icon">
                <img src="./images/icon_tabbar.png" alt="">
            </div>
            <p class="weui-grid__label">我的分数</p>
        </a>  
