...
<body ontouchstart>
 <form action="<?php echo U('Pyschology/add_question');?>" method="post">
        <?php define('NUMBER', $number); ?>
        <div class="weui-cells__title">添加题目</div>
       	<?php $__FOR_START_1860326357__=1;$__FOR_END_1860326357__=NUMBER;for($i=$__FOR_START_1860326357__;$i < $__FOR_END_1860326357__;$i+=1){ ?><div class="weui-cells">
            <div class="weui-cell">
