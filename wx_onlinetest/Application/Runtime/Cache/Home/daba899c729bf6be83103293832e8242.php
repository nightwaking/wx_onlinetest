...
<body ontouchstart>
 <form action="<?php echo U('Admin/add_choice');?>" method="post">
        <div class="weui-cells__title">添加选项</div>
       	<?php $__FOR_START_2126527014__=1;$__FOR_END_2126527014__=5;for($i=$__FOR_START_2126527014__;$i < $__FOR_END_2126527014__;$i+=1){ ?><div class="weui-cells">
            <div class="weui-cell">
